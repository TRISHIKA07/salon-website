...
import salonvideo from './assets/salonvideo.mp4'

export default function TEXTWEBSITE() {
  return (
    <div className="bg-[#390531] text-white min-h-screen font-sans overflow-x-hidden">
      {/* Navbar */}
      <nav className="fixed top-0 left-0 w-full z-50 bg-[#f26e24]/ backdrop-blur-md border-b border-[#FF8C42]/20">
    ...
    Bliss Prime Salon
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl">
         <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6 text-[#f26e24]">
  Beauty Meets Luxury
</h1>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <img
              src={interior}
              alt="Salon Interior"
              className="rounded-3xl shadow-2xl border border-[#f26e24]/20"
            />
          </div>
  ...
  {[
    {
      title: "Hair Styling",
      icon: "✨",
      desc: "Trendy haircuts, smoothening and professional styling."
    },
    {
      title: "Bridal Makeup",
      icon: "✨",
      desc: "Luxury bridal makeover with flawless elegant finishing."
    },
    {
      title: "Facial & Spa",
      icon: "✨",
      desc: "Relaxing facials and spa therapies for glowing skin."
    },
    {
      title: "Nail Art",
      icon: "✨",
      desc: "Creative nail extensions and stylish nail art designs."
    },
    {
      title: "Hair Spa",
      icon: "✨",
      desc: "Deep nourishing treatments for silky healthy hair."
    },
    {
      title: "Skin Care",
      icon: "✨",
      desc: "Advanced skincare treatments for glow and hydration."
    },
    {
      title: "Keratin Treatment",
      icon: "✨",
      desc: "Smooth and frizz-free professional keratin treatment."
    },
    {
      title: "Massage Therapy",
      icon: "✨",
      desc: "Relaxing massage therapies to refresh your body and mind."
    },
  ].map((service, index) => (
    <div
      key={index}
      className="bg-[#4B1D6B]/40 p-8 rounded-3xl border border-[#FF8C42]/20 hover:-translate-y-2 transition duration-300"
    >
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-4 text-lg text-gray-300">
              <a
  href="tel:+919353254491"
  className="block hover:text-[#f26e24]"
>
  📞 +91 9353254491
</a>
<a
  href="mailto:blissprimesalon@gmail.com"
  className="block hover:text-[#f26e24]"
>
  📧 blissprimesalon@gmail.com
</a>
<a
  href="https://maps.app.goo.gl/mXBf9BNzct9HzYvG9"
  target="_blank"
  className="block hover:text-[#f26e24]"
>
  📍 Raipur, Chhattisgarh
  ...
  target="_blank"
  className="block w-full bg-[#FF8C42] hover:bg-[#ff9c5e] py-4 rounded-xl text-lg font-semibold transition shadow-lg shadow-[#FF8C42]/30 text-center"
>
  Send Message
</a>
            </form>
      ...
      <footer className="border-t border-[#FF8C42]/10 py-10 px-6 text-center">
        <h2 className="text-3xl font-bold mb-4">Bliss Prime Salon</h2>
        ...
        <div className="flex justify-center gap-6 mb-6 text-gray-300">
          ...
          <a href="https://wa.me/919353254491" target="_blank" className="hover:text-[#FF8C42]">WhatsApp</a>
        </div>
